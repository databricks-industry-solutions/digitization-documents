...
job_json = {
        ...
        "tasks": [
            {
                "job_cluster_key": "dd_cluster",
                "notebook_task": {
                     "notebook_path": f"00_digitization_context"
                },
                "task_key": "dd_01"
            },
            {
                "job_cluster_key": "dd_cluster",
                "notebook_task": {
                     "notebook_path": f"01_digitization_download"
                },
                "task_key": "dd_02",
                "depends_on": [
                    {
            ...
            {
                "job_cluster_key": "dd_cluster_w_init",
                "notebook_task": {
                     "notebook_path": f"02_digitization_extract"
                },
                "libraries": [
                    {
                        "maven": {
                            "coordinates": "com.databricks.labs:tika-ocr:0.1.2"
                        }
                    }
                ],
                "task_key": "dd_03",
            ...
            },
            {
                ...
                "spark_conf": {
                    ...
                    "init_scripts": [
                        {
                            "dbfs": {
                                "destination": "dbfs:/FileStore/solution_accelerators/digitization/init.sh"
                            }
                        }
                    ],
                    "custom_tags": {
